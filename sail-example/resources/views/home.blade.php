  ...
  <div class="grid grid-cols-4 mb-6">
    ...
    <div class="col-span-2 bg-white rounded p-4">
      ...
      <a href="" class="flex flex-col items-center bg-white mb-6 border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100">
        <img src="{{ $recipe->image }}" class="object-cover rounded-t-lg h-40 w-40 mrounded-none rounded-l-lg" alt="{{ $recipe->title }}">
  ...
  <div class="grid grid-cols-4">
    <div class="col-span-3 bg-white rounded p-4">
      ...
      <div class="flex justify-between items-center mb-6">
        ...
        <a href="" class="max-12 rounded overflow-hidden shadow-lg mx-4 hover:bg-gray-100">
          <img src="{{ $p->image }}" alt="{{ $p->title }}" class="max-h-44 h-44 w-full object-cover">
          <div class="px-6 py-4">
